#ifndef HNSW_BLOOM_FILTER_CUH
#define HNSW_BLOOM_FILTER_CUH
...
struct SharedBloomFilter {
  ...
  // First hash function
  __device__ int hash1(int key) { return (key * 31) % NUM_BITS; }

  // Second hash function
  __device__ int hash2(int key) { return (key * 17 + 7) % NUM_BITS; }
  ...
  // Test for the presence of a key in the Bloom Filter
