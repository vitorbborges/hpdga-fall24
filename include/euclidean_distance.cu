...
template float euclidean_distance_cpu<float>(const float* vec1, const float* vec2, int dimensions);
template double euclidean_distance_cpu<double>(const double* vec1, const double* vec2, int dimensions);
...
// Explicit instantiations for float and double
template __global__ void batch_euclidean_distance_atomic<float>(
    const float* vec1, const float* vec2, float* distances, int num_vectors, int dimensions);

template __global__ void batch_euclidean_distance_atomic<double>(
    const double* vec1, const double* vec2, double* distances, int num_vectors, int dimensions);
